...
module.exports = {
    "run": async (message, bot, args) => {
        ...
        for(let i; i<=matchedText.length-1; i++) matchedText[i] = matchedText[i].slice(1, -1); //  Избавляемся от ковычек по краям у каждого из элементов
    ...
    "help": {
        "category": "Общее",
        "desciption": "Создание голосований",
