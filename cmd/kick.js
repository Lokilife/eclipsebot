...
module.exports = {
    run: async (bot,message,args,con)=> {try{
        if (!args[0]) return addlib.errors.notArgs(message, `Напиши **${con.prefix}help kick** для помощи по команде`) //  Если пользователь не указан
